							...
							<li>
								...
								<form id="reg-form" action="/31401042" method="post">
									<div class="form-item">
										...
										<div class="form-item-right">
											<div class="preloader-mod input-text arrow">
												<input name="f02_qyqc" id="f02_qyqc" value="${UserData.f02_qyqc}" class="text" style="width:275px;" type="text" placeholder="请输入供医院全称"/>
												<span class="arrow-ico"></span>
											</div>
										</div>
									</div>
									<div class="form-item">
										<div class="form-item-left"><em>*</em>医院简称：</div>
										<div class="form-item-right">
									...
									<div class="form-item">
										...
										<div class="form-item-right">
											<div class="input-text">
												<input type="text" name="f18_lxdh" id="f18_lxdh" class="text w300" value="${UserData.f18_lxdh}"/>
											</div>
										</div>
									</div>
									<div class="form-item">
										<div class="form-item-left">院长名称：</div>
										<div class="form-item-right">
											<div class="input-text">
												<input type="text" name="f08_frxm" id="f08_frxm" value="${UserData.f08_frxm}" class="text w120" />
											</div>
										</div>
									</div>
