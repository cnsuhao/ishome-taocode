package org.jfpc.base.login.api;
...
public class TokenApi extends MyFrameworkSupport{
	...
	private RESTResultBean doCheckToken(String token) {
		...
		if(result){
			tb.setResultcode("0");
			tb.setResultmessage("验证成功");
		}else{
			tb.setResultcode("1");
			tb.setResultmessage("验证失败");
		}
		return tb;
	}
	 ...
	 * @return
	 */
	@RequestMapping(value = "/00110011/{token}", method = RequestMethod.GET)
	 ...
	 * @return
	 */
	@RequestMapping(value = "/00110011", method = RequestMethod.GET)
	 ...
	 * @return
	 */
	@RequestMapping(value = "/00110011/{token}", method = RequestMethod.POST)
	@ResponseBody
	 ...
	 * @return
	 */
	@RequestMapping(value = "/00110011", method = RequestMethod.POST)
	@ResponseBody
