...
``` json
Url:        /qxy/securitylog/term=[term]&grade=[grade]&class=[cid]&student=[studentId]&device=[deviceId]&time=[startTime|endTime]&page=[page]&size=[size]&token=[token]
Method:     GET
Header:     Content-type:application/json
Parameter:
    - `term`:        查询的学期id
...
``` json
{
    ...
    "data":{
        ...
        "className":"一班",
        "deviceName":"高三",
        "startTime":"14725325621",               #查询开始时间，需要和markTime对比
        "endTime":"14785652351",                 #查询结束时间，需要和markTime对比
        "flag":"0",
        "securitylog": [
            {
                "studentId":"222",
        ...
        "classalarmrule": [
            {
                ...
                "alarmruleinfo":{
	                ...
	                "timeDate":"1465228800"   #当timeType=1时有效，表示生效的特定日期 
                }
            },		
			{
		        "alarmruleId":"222",
...
示例：
{
    ...
    "alarmrule":{
	    ...
	    "deviceId":"11",           #设备id
        "startTime":"07:00",      #规则执行开始时间，如07:00
        "endTime":"08:00",        #规则执行截止时间，如08:00
        "flag":"0",        #0-进来；1-出去；2-出现
        "timeType":"0",   #时间设置类型：0-指定重复时间（周一到周日），1-特定的日期；
        "timeRepeat":"1111100",   #当timeType=0时有效，1111100表示从周一到周五重复
        "timeDate":"1465228800"   #当timeType=1时有效，表示生效的特定日期
...
Parameter:
    - 'cid':             查询的班级cid
    - 'alarmruleId':    报警规则id集合
    - 'token'：          token
示例：
{
    "token":"fcc277636dea80d3d298df9465795a875e6eb9df",
    "cid": "123",
    "alarmruleIds":[12,23,45]
｝
Response:
    - `status`： 0->token is OK 
                1->CID对应的数据不正确
...
``` json
{
    ...
    "data":{
        ...
        "size":"12",
        "count":"200",
        "termName":"2016-2017-2",             #默认返回缺省学期，如果搜索了其他学期则显示其他学期
        "gradeName":"",                       #默认返回空，如果搜索了年级则显示返回年级
        "className":"",                       #默认返回空，如果搜索了班级则显示返回班级
        "studentrfid":[
              {   
                  "studentId": "3434",
    ...
    "data":{
        ...
        "rfidstudent":[
              {   
                  ...
                  "studentId": "3434",
                  "studentName": "张高丽",          #学生名字
			      "termName":"2016-2017-1",        #班级的学期
			      "gradeName":"高三",               #班级的年级
	              "className":"一班",               #学生的班级
                  "phone": "13415235254",        #手机号
                  "email": "12@qq.com",          #邮箱   
                  "createTime": "1212562545",          #邮箱   
              },
              {   
