...
> 需要使用Token验证查询者身份
> （2016-8-9）liuchiqing：测试地址：139.196.101.78:6666/teacher/info，可正常新增，返回值为200；
...
> 不能批量修改教工
> 需要使用Token验证查询者身份
> （2016-8-9）liuchiqing：测试地址：139.196.101.78:6666/teacher/info，返回值为200，但是数据库未见修改内容；
...
> 需要使用Token验证查询者身份
> （2016-8-9）liuchiqing：测试地址：139.196.101.78:6666/teacher，接口返回500错误；
...
> （2016-8-9）liuchiqing：测试地址：139.196.101.78:6666/label，可正常新增，返回值为200；
``` json
Url:        /qxy/label
Method:     POST
Header:     Content-type:application/json
