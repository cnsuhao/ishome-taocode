...
``` json
{
    ...
    "data": {
        ...
        "startTime":"14752356225",              #目的是显示在通过栏目筛选的位置
        "endTime":"14752356225",                #目的是显示在通过栏目筛选的位置
        ...
        "newslist":[
            {
                ...
                "columeId": "12",      #发布栏目id
                "columeName": "校园风采",   #发布栏目名(对应栏目title)
