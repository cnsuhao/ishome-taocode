package com.hundsun.med.framework.sms.server.monitor;
...
import com.hundsun.med.framework.sms.server.SMSGatewayFactory;
 ...
 * @since 2.1.2
 */
public class RedisMonitorThread extends SMSChannelConfig {
	private Logger logger = LoggerFactory.getLogger(RedisMonitorThread.class);
