...
import org.isotope.jfp.framework.beans.pub.ProxyBean;
 ...
 */
@Service
public class HttpProxyRedisSupport implements ISHttpProxy, ISFrameworkConstants, ISInit {
	 ...
	 * 获得一个代理
	 */
	public HttpProxyBean loadMyHttpProxy(String key) {
		// 获得 一个代理地址
