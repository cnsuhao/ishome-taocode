...
public class CompanyInfoSearchImpl implements ISFrameworkConstants {
	...
	public String getAreaUrl(String areaCode) {
		return (String) mq.getObject(COMPANY_URL + areaCode, false);
	}
