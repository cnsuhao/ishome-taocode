CREATE TABLE mep_score
(
    mep_score_id BIGINT(12) unsigned NOT NULL AUTO_INCREMENT COMMENT '评分id',
    term_id BIGINT(12) NOT NULL COMMENT '学期id',
    cid BIGINT(12) NOT NULL COMMENT '班级id',
    student_id BIGINT(12) NOT NULL COMMENT '学生id',
    mep_item_id BIGINT(12) NOT NULL COMMENT '德育项目id',
    scroe_order VARCHAR(2) NOT NULL COMMENT '德育个人评分序号',
    scroe VARCHAR(12) COMMENT '德育个人评分',
