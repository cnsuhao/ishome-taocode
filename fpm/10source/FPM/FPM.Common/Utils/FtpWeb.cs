...
namespace FPM.Common.Utils
{
    class FtpWeb
    {
        ...
        public String CurFtpURI { get; set; }
        ...
        public FtpWeb(string FtpServerIP, string FtpRemotePath, string FtpUserID, string FtpPassword)
        {
            ...
            if (String.IsNullOrEmpty(ftpRemotePath) || ftpRemotePath.Equals("/"))
                CurFtpURI = "ftp://" + ftpServerIP + "/";
            else
                CurFtpURI = "ftp://" + ftpServerIP + "/" + ftpRemotePath + "/";
        }
        ...
        public void Upload(string filename)
        {
            ...
            string uri = CurFtpURI + fileInf.Name;
        ...
        public void Download(string filePath, string fileName)
        {
            ...
            try
            {
                FileStream outputStream = new FileStream(filePath + "ConfigUtil.SPLIT_WIN" + fileName, FileMode.Create);

                reqFTP = (FtpWebRequest)FtpWebRequest.Create(new Uri(CurFtpURI + fileName));
                reqFTP.Timeout = Timeout;
        ...
        public void RemoveDirectory(string folderName)
        {
            try
            {
                string uri = CurFtpURI + folderName;

                //删除该目录下面的全部文件
                foreach (String DetailFile in GetFileList(""))
                {
                    Delete(DetailFile);
                }
        ...
        public string[] GetFilesDetailList()
        {
            try
            {
                ...
                FtpWebRequest reqFTP;
                reqFTP = (FtpWebRequest)FtpWebRequest.Create(new Uri(CurFtpURI));
                reqFTP.Timeout = Timeout;
                reqFTP.Credentials = new NetworkCredential(ftpUserID, ftpPassword);
        ...
        public string[] GetDirectoryList()
        {
            ...
            foreach (string str in drectory)
            {
                ...
                else if (str.Trim().Substring(0, 1).ToUpper() == "D")
                {
                    /*判断 Unix 风格*/
                    //54？？？？？？？？？？？？
                    string dir = str.Substring(str.LastIndexOf(" ")).Trim();
                    if (dir != "." && dir != "..")
                    {
                        m += dir + "\n";
                    }
        ...
        public void MakeDir(string dirName)
        {
            ...
            try
            {
                ...
                String MakePath = CurFtpURI + dirName;
                reqFTP = (FtpWebRequest)FtpWebRequest.Create(new Uri(MakePath));
                reqFTP.Timeout = Timeout;
        ...
        public void ReName(string currentFilename, string newFilename)
        {
            ...
            {
                FtpWebRequest reqFTP;
                reqFTP = (FtpWebRequest)FtpWebRequest.Create(new Uri(CurFtpURI + currentFilename));
                reqFTP.Timeout = Timeout;
        ...
        public void GotoDirectory(string DirectoryName, bool IsRoot)
        {
            ...
            CurFtpURI = "ftp://" + ftpServerIP + "/" + ftpRemotePath.Replace("//","/");
        }
