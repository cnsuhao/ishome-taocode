package org.isotopes.jfp.framework.mybatis.plugin;
...
import org.isotopes.jfp.framework.support.impl.MyFrameworkSqlSourceSupport;
...
public class MyFrameworkDialectPlugin implements Interceptor {
	...
	private void processIntercept(Object[] queryArgs) throws Throwable {
		...
		if (dialect.supportsLimit()) {
			...
			// 保存sql语句
			MappedStatement newMs = copyFromMappedStatement(ms, new MyFrameworkSqlSourceSupport(ms.getConfiguration(), sql, boundSql.getParameterMappings()));
			// 设定操作参数MAPPED
