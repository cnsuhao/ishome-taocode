...
<body>
	<div class="container-fluid">
		<form class="form-horizontal" role="form" action="/31608004"
			method="post" id="form1" enctype="multipart/form-data">
			<input type="hidden" name="puk" value="${dbo.puk }">
			...
			<div class="form-group">
				...
				<div class="col-sm-4">
					<input type="text" id="f02_pxwz"
						class="form-control col-xs-13 col-sm-12" name="f02_pxwz" value="${dbo.f02_pxwz }"
						check-type="required" />
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-sm-4">
					<input type="text" id="k01_dflid"
						class="form-control col-xs-13 col-sm-12" name="k01_dflid" value="${dbo.k01_dflid }"
						check-type="required" />
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-sm-4">
					<input type="text" id="n01_dflmc"
						class="form-control col-xs-13 col-sm-12" name="n01_dflmc" value="${dbo.n01_dflmc }"
						check-type="required" />
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-sm-4">
					<input type="text" id="k02_zflid"
						class="form-control col-xs-13 col-sm-12" name="k02_zflid" value="${dbo.k02_zflid }"
						check-type="required" />
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-sm-4">
					<input type="text" id="n02_zflmc"
						class="form-control col-xs-13 col-sm-12" name="n02_zflmc" value="${dbo.n02_zflmc }"
						check-type="required" />
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-sm-4">
					<input type="text" id="k03_xflid"
						class="form-control col-xs-13 col-sm-12" name="k03_xflid" value="${dbo.k03_xflid }"
						check-type="required" />
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-sm-4">
					<input type="text" id="n03_xflmc"
						class="form-control col-xs-13 col-sm-12" name="n03_xflmc" value="${dbo.n03_xflmc }"
						check-type="required" />
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-sm-4">
					<input type="text" id="f01_bt"
						class="form-control col-xs-13 col-sm-12" name="f01_zdmc" value="${dbo.f01_zdmc }"
						check-type="required" />
				</div>
			</div>																						
