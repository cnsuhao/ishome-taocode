...
public class CorpSearchName {
	...
	// String placeWord[] =
	// {"南京市","江宁区","溧水县","高淳县","六合县","江浦县","徐州市","邳州市","新沂市","铜山县","睢宁县","沛县",
	...
	private String placeWord[] = { "南京市", "江宁区", "溧水县", "高淳县", "六合县", "江浦县", "徐州市", "邳州市", "新沂市", "铜山县", "睢宁县", "沛县",
			"丰县", "连云港市", "赣榆县", "灌云县", "东海县", "灌南县", "淮安", "楚州区", "清浦区 ", "清河区", "淮阴区", "涟水县", "洪泽县", "金湖县", "盱眙县",
			"宿迁市", "宿豫县", "沭阳县", "泗阳县", "泗洪县", "盐城市", "东台市", "大丰市", "盐都县", "建湖县", "响水县", "射阳县", "阜宁县", "滨海县", "扬州市",
			"高邮市", "江都市", "仪征市", "胥浦", "邢江区", "宝应县", "泰州市", "泰兴市", "姜堰市", "靖江市", "兴化市", "南通市", "如皋市", "通州市", "海门市",
			"启东市", "海安县", "如东县", "镇江市", "扬州市", "丹阳市", "句容市", "丹徒县", "常州市", "武进市", "金坛市", "溧阳市", "无锡市", "宜兴市", "江阴市",
			"苏州市", "吴江市", "昆山市", "太仓市", "常熟市", "张家港市", "南京", "江宁", "溧水", "高淳", "六合", "江浦", "徐州", "邳州", "新沂", "铜山", "睢宁",
			"沛", "丰", "连云港", "赣榆", "灌云", "东海", "灌南", "淮安", "楚州", "清浦 ", "清河", "淮阴", "涟水", "洪泽", "金湖", "盱眙", "宿迁", "宿豫",
			"沭阳", "泗阳", "泗洪", "盐城", "东台", "大丰", "盐都", "建湖", "响水", "射阳", "阜宁", "滨海", "扬州", "高邮", "江都", "仪征", "胥浦", "邢江",
			"宝应", "泰州", "泰兴", "姜堰", "靖江", "兴化", "南通", "如皋", "通州", "海门", "启东", "海安", "如东", "镇江", "扬州", "丹阳", "句容", "丹徒",
			"常州", "武进", "金坛", "溧阳", "无锡", "宜兴", "江阴", "苏州", "吴江", "昆山", "太仓", "常熟", "张家港" };

	private String goodWord[] = { "一", "二", "三", "四", "五", "六", "七", "八", "九", "十", "电", "奇", "琪", "晴", "庆", "兴", "巧",
			"俏", "瑞", "仁", "同", "婷", "勇", "玉", "羽", "阳", "雅", "胖", "风", "音", "雨", "朋", "胖", "盼", "绿", "爱", "生", "顺",
			"素", "火", "胜", "土", "东", "南", "西", "北", "春", "夏", "秋", "冬", "多", "福", "丰", "富", "发", "芳", "高", "贵", "合",
			"华", "辉", "慧", "俊", "洁", "嘉", "静", "佳", "景", "吉", "康", "客", "龙", "兰", "真", "早", "信", "学", "星", "晓", "香",
			"秀", "霞", "晨", "诚", "财", "宝", "美", "满", "中", "长", "健", "千", "万", "大", "小" };

	private String preWord[] = { "小", "大", "老" };

	private String afterWord[] = { "氏" };

	private String familyName[] = { "赵", "钱", "孙", "李", "周", "吴", "郑", "王", "冯", "陈", "楮", "卫", "蒋", "沈", "韩", "杨", "朱",
	...
	public void init() {
		...
		// areaType = "BJ,NMG,JS,ZJ,GD,HaiN,QH".split(",");
		//
		// // seqCorpBJ =
		// Integer.valueOf(PropertyHelper.getKeyValue("seqCorpBJ"));
		// seqCorpTJ = Integer.valueOf(PropertyHelper.getKeyValue("seqCorpTJ"));
		// seqCorpHeB =
		// Integer.valueOf(PropertyHelper.getKeyValue("seqCorpHeB"));
		// seqCorpSX2 =
		// Integer.valueOf(PropertyHelper.getKeyValue("seqCorpSX2"));
		// // seqCorpNMG =
		// Integer.valueOf(PropertyHelper.getKeyValue("seqCorpNMG"));
		// //东北
		// seqCorpLN = Integer.valueOf(PropertyHelper.getKeyValue("seqCorpLN"));
		// seqCorpHLJ =
		// Integer.valueOf(PropertyHelper.getKeyValue("seqCorpHLJ"));
		// //华东
		...
		// //华南
		// //seqCorpGD =
		// Integer.valueOf(PropertyHelper.getKeyValue("seqCorpGD"));
		// seqCorpGX = Integer.valueOf(PropertyHelper.getKeyValue("seqCorpGX"));
		// //seqCorpHaiN =
		// Integer.valueOf(PropertyHelper.getKeyValue("seqCorpHaiN"));
		// //华中
		// seqCorpHeN =
		// Integer.valueOf(PropertyHelper.getKeyValue("seqCorpHeN"));
		...
		// //西北
		// seqCorpSX1 =
		// Integer.valueOf(PropertyHelper.getKeyValue("seqCorpSX1"));
		...
		//
		// seqGoodWord =
		// Integer.valueOf(PropertyHelper.getKeyValue("seqGoodWord"));
	...
	private void initial() {
		...
		// for(int i = 0; i<placeWord.length; i++){
		// for(int j = 0; j<familyName.length; j++){
		// corpSearchNameShi[i*placeWord.length+j] =
		// placeWord[i]+familyName[j]+"氏";
		// }
		// }
	...
	// 获得一个等待运行的城市
	public String[] getCorpSearchCorp2() throws Exception {
	...
	public String getCorpNameForService(String areaCode) throws Exception {
		...
		try {
			...
			if (json_Obj.getJSONArray("data") != null) {
				List<String> list = (List<String>) json_Obj.getJSONArray("data");
