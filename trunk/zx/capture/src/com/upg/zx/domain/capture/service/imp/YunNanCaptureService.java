 ...
 *
 */
public class YunNanCaptureService extends CaptureServiceImp {
	private final String WORD_CHECK_MODE = "1";
	...
	protected String getSessionIdByCookie(final List<Cookie> cookies) {
		for (Cookie cookie : cookies) {
			if ("JSESSIONID_NOTICE".equals(cookie.getName().toUpperCase())) {
