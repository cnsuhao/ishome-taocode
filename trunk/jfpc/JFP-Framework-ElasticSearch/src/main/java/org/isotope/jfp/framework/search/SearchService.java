...
public class SearchService {
	...
	public static void main(String[] args) throws Exception {
		...
		// JSONObject json =
		// JSONObject.parseObject(HttpServiceHelper.doHttpGET("http://127.0.0.1:9200/qcc_company_1/_search?q="
		// + key + "&pretty"));
		// // System.out.println(json.get("hits"));
		// // System.out.println(((JSONObject)json.get("hits")).get("hits"));
		// JSONArray jhits = (JSONArray) ((JSONObject)
		// json.get("hits")).get("hits");
		// for (Object hit : jhits) {
		// //System.out.println("===1111==" + ((JSONObject)
		// hit).get("_source").toString());
		// CorpBase corp = JSON.parseObject(((JSONObject)
		// hit).get("_source").toString(), CorpBase.class);
