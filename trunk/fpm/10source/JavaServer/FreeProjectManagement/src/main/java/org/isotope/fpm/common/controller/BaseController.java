...
import org.isotope.fpm.common.service.IService;
import org.isotope.fpm.common.service.ServiceManager;
import org.isotope.fpm.common.util.ServerTools;
...
public class BaseController {
	...
	public String errorController(@PathVariable String BID,// 业务ID
	        ...
	        FromDateBean fdb, Locale locale, Model model) throws Exception {
	 ...
	 */
	@RequestMapping(value = "/{BIDCID}", method = RequestMethod.POST)
	public String defaultController(@PathVariable String BID,// 业务ID
	        @PathVariable String UID,// 登录者识别ID
	        @PathVariable int CID,// 操作编码
	        FromDateBean fdb, Locale locale, Model model) {
		logger.info("Welcome home! the client locale is " + locale.toString());

		// 返回数据
		FromDateBean returnFromDateBean = new FromDateBean();
		//对象池~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
		//UID
